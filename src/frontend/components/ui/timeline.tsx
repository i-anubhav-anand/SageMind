  ...
  "col-start-2 col-end-3 row-start-1 row-end-2 mt-3.5 flex size-3 items-center justify-center rounded-full z-10 bg-background",
  {
    variants: {
      status: {
        ...
        custom: "[&>*:not(:nth-child(4))]:hidden [&>*:nth-child(4)]:block [&>*:nth-child(4)]:size-2",
      },
    },
    defaultVariants: {
      status: "default",
...
const timelineContentVariants = cva("row-start-1 row-end-2 text-muted-foreground", {
  variants: {
    side: {
...
const timelineHeadingVariants = cva("row-start-2 row-end-3 line-clamp-1 max-w-full truncate", {
  variants: {
    side: {
      right: "col-start-3 col-end-4 mr-auto text-left",
      left: "col-start-1 col-end-2 ml-auto text-right",
